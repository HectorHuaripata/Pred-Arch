...
POLKIT_ACTIONS = {
    ...
    "Audio.SetMicDrc": "io.otectus.archer1.set-hardware",
    "Audio.SetMicBeamforming": "io.otectus.archer1.set-hardware",
    "Audio.SetMicBeamAngle": "io.otectus.archer1.set-hardware",
...
FEATURE_GATES = {
    ...
    "Audio.SetMicBeamforming": ("audio_dsp",),
    "Audio.SetMicBeamAngle": ("audio_dsp",),
}
